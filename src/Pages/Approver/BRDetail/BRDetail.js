        ...
        <div>
            ...
            <div className="container">
                <div className="details">
                    ...
                    <p><strong>ชื่อผู้เบิก:</strong> {requestDetails.name}</p>
                    ...
                    <p><strong>หมายเหตุการขอเบิก:</strong> {requestDetails.note}</p>
                    <p><strong>จำนวน:</strong> {requestDetails.amount}</p>
                    <p><strong>วันที่เบิก:</strong> {requestDetails.requestDate}</p>
                </div>
